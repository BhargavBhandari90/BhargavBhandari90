...
|---------|-------------|--------------|-------|
| **[The Guide Block](https://github.com/BhargavBhandari90/the-guide-block/)** | A WordPress block that lets you create step-by-step guides, tutorials, or workflows directly in the editor. Perfect for how-tos, onboarding, and process documentation—structured, intuitive, and easy to follow. | WordPress, Gutenberg, React, Interactivity API | [WordPress Plugin Directory](https://wordpress.org/plugins/the-guide-block/) |
